package com.brandon.metrics.gateway.auth;
...
//	@Value("${mygateway.urls}")
	private String[] skipAuthUrls = new String[] {"/baidu"};
    ...
    private Mono<Void> authErro(ServerHttpResponse resp,String mess) {
        ...
        ReturnData<String> returnData = new ReturnData<>(HttpStatus.NON_AUTHORITATIVE_INFORMATION.value(), mess, mess);
        String returnStr = "";
        try {
